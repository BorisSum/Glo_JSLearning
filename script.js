...
AppData.prototype.showResult = function () {
   ...
   periodSelectElem.addEventListener('input', function () {
      incomePeriodValElem.value = _this.calcPeriod();
   });
};
...
AppData.prototype.eventHandlers = function () {

   btnCalculateElem.addEventListener('click', this.start.bind(this));

   btnCancelElem.addEventListener('click', this.resetCalc.bind(this));

   btnExpensesAddElem.addEventListener('click', this.addExpensesBlock.bind(this));
   btnIncomeAddElem.addEventListener('click', this.addIncomeBlock.bind(this));
